...
//                System.out.println(node.getClass() + "_" + node.toString() + "_" + node.getBegin().get().line + "_" + node.getEnd().get().line);
    ...
    public static void main(String[] args) {
        ...
        sliceFile(new File("D:\\SliceNewData\\commons-io-b5990be69139f0b04919bc097144a105051aafcc#FileUtils#RV_RETURN_VALUE_IGNORED_BAD_PRACTICE#BAD_PRACTICE#2#1156#1156#false.java")
        , "doCopyFile" , new ArrayList<>());
    }
}